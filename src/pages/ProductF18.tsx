    ...
    <>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="mb-20">
            <UnlockMethodCards methods={f18.unlockMethods} />
          </div>
          ...
          <div className="mt-20 mb-20 rounded-2xl border border-border bg-muted/50 p-10">
            ...
            <p className="text-sm text-muted-foreground mb-8 max-w-xl">
              {t(
                ...
                "Le Sentinel Pro est disponible en option dans toutes les offres KGS. Choisissez l'offre adaptée à vos besoins, puis sélectionnez ce produit lors de la configuration."
              )}
            </p>
            <Link
              to="/offers/entry"
