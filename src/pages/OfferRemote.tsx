        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          {offer.addon && (
            ...
            >
              ...
              <div className="rounded-2xl border border-accent/20 bg-card p-8 max-w-lg">
                <h3 className="text-xl font-heading font-bold text-foreground mb-2">
                  {offer.addon.name}
                </h3>
                <p className="text-lg font-semibold text-accent mb-4">{offer.addon.price[lang]}</p>
                <ul className="space-y-3">
                  {offer.addon.features.map((af) => (
                    <li key={af[lang]} className="flex items-start gap-3 text-sm text-muted-foreground">
