    ...
    <section className="py-32 bg-blue-grey">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-sm text-chrome/60 mb-16">
        ...
        <div className="max-w-xl mx-auto">
          {!showResult ? (
            ...
            >
              <p className="text-xs text-chrome/50 mb-2 tracking-wider uppercase">
              ...
              <div className="grid gap-3">
                {steps[currentStep].options.map((option) => (
                  <button
                    ...
                    className="text-left px-6 py-4 rounded-xl border border-chrome/15 bg-deep/50 hover:border-silver-accent/40 hover:bg-silver-accent/5 transition-all duration-300 text-ivory font-light"
                  >
                    {option}
                  </button>
                ))}
            ...
            >
              ...
              <p className="text-chrome-light font-light mb-10">
                Based on your preferences, this system best suits your environment.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to={recommendation.link}
                  className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-ivory text-deep text-sm font-medium tracking-wide hover:opacity-90 transition-opacity"
                >
                ...
                <button
                  onClick={reset}
                  className="px-8 py-3.5 rounded-full border border-chrome/20 text-sm font-light text-chrome-light hover:border-silver-accent/30 transition-all duration-300"
                >
                  Start over
                </button>
              </div>
